...
import { arePathsEqual } from '../components/lib/ArePathsEqual';
import { camelize } from '../components/lib/String';
...
export class Polyline extends React.Component {
  ...
  renderPolyline() {
    const { map, google, path, strokeColor, strokeOpacity, strokeWeight, ...props } = this.props;
